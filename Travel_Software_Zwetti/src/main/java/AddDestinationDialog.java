...
public class AddDestinationDialog extends javax.swing.JDialog {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddActionPerformed
        if (selection) {
            //PLZ Eingabe
            String plz = this.tfPlz.getText();
            String seletedItem = this.cbLand.getSelectedItem().toString();
            plzString = seletedItem.substring(seletedItem.indexOf(":") + 2);
            plzString = plz + "," + plzString;
        } else {
            //Name Eingabe
        plzString = this.tfPlz.getText();
